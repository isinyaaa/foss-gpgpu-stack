...
Although it is not always possible to convert a \text{serial} task into a
...
After that, we use \texit{latent Dirichlet allocation} LDA to group the
...
\todo{decide on another algorithm}
